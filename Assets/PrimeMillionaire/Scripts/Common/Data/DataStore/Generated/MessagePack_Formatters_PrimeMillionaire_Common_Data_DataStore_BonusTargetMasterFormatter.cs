...
{
    public sealed class BonusTargetMasterFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::PrimeMillionaire.Common.Data.DataStore.BonusTargetMaster>
    {
        // Type
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::PrimeMillionaire.Common.Data.DataStore.BonusTargetMaster value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
        ...
        public global::PrimeMillionaire.Common.Data.DataStore.BonusTargetMaster Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::PrimeMillionaire.Common.Data.DataStore.BonusTargetMaster(__Type__, __SkillTypes__);
            reader.Depth--;
            return ____result;
        }
    }
